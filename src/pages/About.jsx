    ...
    return (
        <div className="py-16 md:py-24">
            <Container>
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-6">About <span className="text-indigo-600 dark:text-indigo-400">SimpleEarn</span></h1>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
                    ...
                    <motion.div
                        initial={{ opacity: 0, x: 50 }}
                        whileInView={{ opacity: 1, x: 0 }}
                        className="bg-indigo-600 rounded-3xl p-8 text-white shadow-2xl shadow-indigo-200 dark:shadow-none"
                    >
